            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50">
                  <th className="px-6 py-3 text-left font-semibold text-xs uppercase tracking-wider text-slate-500 dark:text-slate-400">
                    {t("users.colMember")}
                  </th>
                  <th className="px-4 py-3 text-left font-semibold text-xs uppercase tracking-wider text-slate-500 dark:text-slate-400">
                    {t("users.colRole")}
                  </th>
                  <th className="px-4 py-3 text-left font-semibold text-xs uppercase tracking-wider text-slate-500 dark:text-slate-400">
                    {t("users.colJoined")}
